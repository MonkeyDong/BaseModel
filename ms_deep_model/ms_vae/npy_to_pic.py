...
nn = len(files)
Xt1 = np.zeros((nn,2416))
for m,n in enumerate(files):
	Xt1[m,:] = np.load("datas_mz/ACt/"+n)
...
nn = len(files)
Xt2 = np.zeros((nn,2416))
for m,n in enumerate(files):
	Xt2[m,:] = np.load("datas_mz/NMt/"+n)
...
nn = len(files)
Xt3 = np.zeros((nn,2416))
for m,n in enumerate(files):
	Xt3[m,:] = np.load("datas_mz/PPt/"+n)
...
nn = len(files)
Xs1 = np.zeros((nn,2416))
for m,n in enumerate(files):
	Xs1[m,:] = np.load("datas_mz/ACs/"+n)
...
nn = len(files)
Xs2 = np.zeros((nn,2416))
for m,n in enumerate(files):
	Xs2[m,:] = np.load("datas_mz/NMs/"+n)
...
nn = len(files)
Xs3 = np.zeros((nn,2416))
for m,n in enumerate(files):
	Xs3[m,:] = np.load("datas_mz/PPs/"+n)
